...
RUN set -ex \
    ...
    && go build -v -trimpath -tags \
        with_quic,with_grpc,with_dhcp,with_wireguard,with_shadowsocksr,with_ech,with_utls,with_reality_server,with_acme,with_clash_api,with_v2ray_api,with_gvisor \
        -o /go/bin/sing-box \
